...
export function GameHeader({
  ...
  locationIndicatorClass: _locationIndicatorClass,
  onAdvanceDay,
  onLogout,
  onResetStory,
}: GameHeaderProps) {
  return (
    <header className="sticky top-0 z-20 -mx-1 flex items-center justify-between gap-3 px-1 py-0 backdrop-blur-[6px]">
